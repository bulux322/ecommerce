                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-4 col-md-6 col-grid-box">
                        <div class="card blog-categority">
                            <a href="{{ route('user.blogpost.details',['slug'=>$post->slug])}}" class="blog-img">
                                <img src="{{ asset('assets/images/blog/' . $post->image) }}" alt=""
                            ...
                            <div class="card-body">
                                ...
                                <div class="blog-profile">
                                    <div class="image-name">
                                        <h3>Admin</h3>
                                        <h6>{{ $post->created_at ? $post->created_at->format('d M Y') : 'Tanggal tidak tersedia' }}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
