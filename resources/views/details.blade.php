                                    ...
                                    <div class="customer-review-box">
                                        ...
                                        <div class="customer-section">
                                            <div class="customer-profile">
                                                <img src="{{asset('assets/images/inner-page/review-image/1.jpg')}}"
                                                    class="img-fluid blur-up lazyload" alt="">
                                            </div>
                                        ...
                                        <div class="customer-section">
                                            <div class="customer-profile">
                                                <img src="{{asset('assets/images/inner-page/review-image/3.jpg')}}"
                                                    class="img-fluid blur-up lazyload" alt="">
                                            </div>
                                        ...
                                        <div class="customer-section">
                                            <div class="customer-profile">
                                                <img src="{{asset('assets/images/inner-page/review-image/4.jpg')}}"
                                                    class="img-fluid blur-up lazyload" alt="">
                                            </div>
                    ...
                    <div class="product-box">
                        ...
                        <div class="product-details">
                            ...
                            <div class="main-price">
                                ...
                                <h3 class="theme-color">Rp.@if($rproduct->sale_price){{$product->sale_price}}
                                    @else
